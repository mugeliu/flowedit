...
(function (J, ne) {
      ...
      return (
        ...
        u <= 0 || u > e
          ? (r && (clearTimeout(r), (r = null)),
            ...
            (s = n.apply(o, i)),
            r || (o = i = null))
          : !r && t.trailing !== !1 && (r = setTimeout(l, u)),
        s
      );
    };
  }
  ...
  class d {
    ...
    static findAllInputs(e) {
      return xo(e.querySelectorAll(d.allInputsSelector)).reduce(
        (t, o) =>
  ...
  class b {
    ...
    static get rect() {
      ...
      if (
        ...
        return (
          T("Method SelectionUtils.rangeCount is not supported", "warn"), o
        );
  ...
  var _ = ((n) => (
      (n.Default = "default"), (n.Separator = "separator"), (n.Html = "html"), n
    ))(_ || {}),
    te = ((n) => (
      ...
      super(...arguments),
        ...
        (this.convert = async (e, t, o) => {
          ...
          if (c && u) {
            ...
            const g = [c ? !1 : Le(r.name), u ? !1 : Le(t)]
              .filter(Boolean)
              .join(" and ");
            throw new Error(
        ...
        (this.insertMany = (
          ...
          return (
            this.Editor.BlockManager.insertMany(o, t), o.map((i) => new ee(i))
          );
        });
    }
    get methods() {
...
`)
    ...
    constructor(e) {
      (this.nodes = {
        ...
        e.description !== void 0 &&
          ((this.nodes.description = d.make("div", Te.description, {
  ...
  class le extends pt {
    ...
    make(e, t) {
      ...
      return (
        ...
        e.title !== void 0 &&
          i.appendChild(d.make("div", L.title, { innerHTML: e.title || "" })),
        e.secondaryLabel &&
          i.appendChild(
            d.make("div", L.secondaryTitle, { textContent: e.secondaryLabel })
          ),
        this.hasChildren &&
          i.appendChild(
            d.make("div", [L.icon, L.iconChevronRight], { innerHTML: Ui })
          ),
  ...
  var Z = ((n) => (
    (n.Closed = "closed"), (n.ClosedOnActivate = "closed-on-activate"), n
  ))(Z || {});
  ...
  class Se extends pt {
    constructor(e, t) {
      var o, i;
      super(e),
        (this.nodes = { root: d.make("div", Ko.root) }),
  ...
  class Xo extends we {
    constructor(e, t = {}) {
      super(),
        ...
        (this.nodes = {}),
        (this.nodes.popoverContainer = d.make("div", [P.popoverContainer])),
        ...
        (this.nodes.items = d.make("div", [P.items])),
        ...
        (this.nodes.popover = d.make("div", [P.popover, this.params.class])),
  ...
  class os extends we {
    constructor({ items: e, placeholder: t }) {
      super(),
        (this.listeners = new Ee()),
        (this.items = e),
        (this.wrapper = d.make("div", bt.wrapper));
  ...
  class rs extends vt {
    ...
    showNestedPopoverForItem(e) {
      ...
      return (
        t.getElement().classList.add(P.getPopoverNestedClass(t.nestingLevel)), t
      );
    }
    handleItemClick(e) {
      var t;
  ...
  class Zo extends Xo {
    constructor(e) {
      super(e, {
        ...
        (this.history = new cs()),
        (this.isHidden = !0),
        (this.nodes.overlay = d.make("div", [P.overlay, P.overlayHidden])),
  ...
  const wt = class Un extends we {
    constructor({ api: e, tools: t, i18nLabels: o }) {
      super(),
        ...
        (this.nodes = { toolbox: d.make("div", Un.CSS.toolbox) }),
        this.initPopover(),
  ...
  class vs extends E {
    ...
    async make() {
      ...
      const e = d.make("div");
      e.appendChild(document.createTextNode(H.ui(W.ui.toolbar.toolbox, "Add"))),
        e.appendChild(
          d.make("div", this.CSS.plusButtonShortcut, { textContent: "/" })
        ),
  ...
  var ce = ((n) => (
    ...
    en = ((n) => (
      (n.Shortcut = "shortcut"), (n.SanitizeConfig = "sanitize"), n
    ))(en || {}),
    ve = ((n) => (
      ...
      for (const [o, i] of this.tools) {
        ...
        [s].flat().forEach((c) => {
          ...
          if (d.isElement(c)) {
            ...
            e.push(g);
          } else if (c.type === _.Html) e.push({ ...u, ...c, type: _.Html });
  ...
  function or(n) {
    ...
    return (0, tr.isNativeInput)(n)
      ...
      ? n.length
      : (t =
          (e = n.textContent) === null || e === void 0 ? void 0 : e.length) !==
          null && t !== void 0
      ? t
      : 0;
  }
  ...
  class Qr extends E {
    ...
    async update(e, t, o) {
      ...
      return (
        this._blocks.replace(r, s), this.blockDidMutated(An, s, { index: r }), s
      );
    }
    replace(e, t, o) {
  ...
  const Ln = class Wn extends E {
    ...
    async processDataTransfer(e, t = !1) {
      ...
      const c = Object.keys(this.toolsTags).reduce(
          (p, g) => (
            (p[g.toLowerCase()] = this.toolsTags[g].sanitizationConfig ?? {}), p
          ),
          {}
        ),
  ...
  class Ie extends E {
    ...
    genHTML() {
      const { UI: e } = this.Editor,
        ...
        o = d.make("div", Ie.CSS.overlay, {}),
        i = d.make("div", Ie.CSS.overlayContainer, {}),
