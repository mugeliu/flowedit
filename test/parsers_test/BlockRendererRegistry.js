...
const logger = {
  error: (...args) => console.error('[BlockRendererRegistry]', ...args),
  warn: (...args) => console.warn('[BlockRendererRegistry]', ...args),
  info: (...args) => console.info('[BlockRendererRegistry]', ...args),
  debug: (...args) => console.debug('[BlockRendererRegistry]', ...args)
};
