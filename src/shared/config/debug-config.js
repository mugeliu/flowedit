...
export const MODULE_LOG_LEVELS = {
  ...
  // 'HistorySettings': 'DEBUG',
  // 'ArticlePreview': 'DEBUG'
};
...
export function applyDebugConfig(logger) {
  ...
  // 应用模块级别的日志控制
  if (MODULE_LOG_LEVELS && typeof MODULE_LOG_LEVELS === 'object') {
    // 这里可以扩展模块级别的日志控制逻辑
    console.log("[FlowEdit] 模块级别日志配置已加载");
  }
}